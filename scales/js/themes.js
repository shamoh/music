...
export const VISUAL_PROFILES = [
  ...
  },
  {
    ...
    vars: {
      ...
      '--border':     '#c0c0d8',
      '--note-tonic':        '#cc0022',
      '--note-tonic-ledger': '#cc0022',
      '--note-tonic-label':  '#cc0022',
      '--note-chord':        '#c0002a',
      '--note-chord-ledger': '#c0002a',
      '--note-chord-label':  '#c0002a',
      '--note-scale':        '#903550',
      '--note-scale-ledger': '#903550',
      '--note-scale-label':  '#903550',
      '--note-muted':        '#d4d4e4',
      '--note-muted-ledger': '#d4d4e4',
      '--note-muted-label':  '#d4d4e4',
      '--font-scale': '1',
    },
  },
  {
